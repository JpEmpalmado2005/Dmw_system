...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($_POST['form_action'] === 'edit' && !empty($_POST['record_id'])) {
        ...
        if ($stmt->execute()) {
            ...
            echo '<script>setTimeout(function(){ window.location.href = "Evaluation.php"; }, 1500);</script>';
        } else {
...
?>
                ...
                <div class="form-container" <?php if(!isset($_GET["action"])): ?> style="display:none;" <?php endif; ?>>
                    ...
                    <form id="evaluation-form" class="data-form" action="<?=$_SERVER['PHP_SELF']?>" method="POST">
                        ...
                        <div class="form-actions">
                            <a href="Evaluation.php" class="btn btn-cancel">Cancel</a>
                            <button type="submit"
            ...
            echo generateDataTable( $headers, $data, "No Evaluation records found", true );
        ?>
                        </div>
                    </div>
                </div>
